...
/**
 * Tests for {@link DefaultActivityPubObjectReferenceDeserializer}.
 *
 * @version $Id$
 */
@ComponentTest
public class DefaultActivityPubObjectReferenceDeserializerTest
{
    ...
    @Test
    public void deserializeURI() throws Exception
    {
