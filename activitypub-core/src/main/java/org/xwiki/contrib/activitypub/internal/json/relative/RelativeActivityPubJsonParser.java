...
/**
 * An implementation of {@link ActivityPubJsonParser} that relies on the {@link RelativeObjectMapperConfiguration}.
 *
 * @version $Id$
 * @since 1.2
 */
...
@Named("relative")
@Singleton
public class RelativeActivityPubJsonParser extends AbstractActivityPubJsonParser
{
    @Inject
    @Named("relative")
