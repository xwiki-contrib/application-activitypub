...
/**
 * Common class for the activitypub mention listeners.
 *
 * @version $Id$
 * @since 1.5
 */
public abstract class AbstractActivityPubMentionEventListener implements EventListener
{
    @Inject
    ...
    protected Optional<XWikiDocument> resolveDoc(MentionNotificationParameters mentionNotificationParameters)
    {
