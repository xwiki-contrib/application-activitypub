...
{
    @Override public void handleInboxRequest(ActivityRequest<Reject> activityRequest)
        throws IOException, ActivityPubException
    {
        
    }

    @Override public void handleOutboxRequest(ActivityRequest<Reject> activityRequest)
        throws IOException, ActivityPubException
    {
