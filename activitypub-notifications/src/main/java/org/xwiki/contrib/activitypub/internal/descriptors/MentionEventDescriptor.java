...
/**
 * Event descriptor for {@link MentionEvent}.
 *
 * @since 1.4
 * @version $Id$
 */
...
public class MentionEventDescriptor extends AbstractActivityPubEventDescriptor
{
    @Override
    ...
    {
        return "activitypub.mention.event.description";
    }
}
